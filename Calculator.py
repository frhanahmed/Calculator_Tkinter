from tkinter import*
root=Tk() #creating canvas
root.title("Simple Calculator") #Canvas name

e=Entry(root,width=50,borderwidth=5) #creating dialog box for writing numbers
